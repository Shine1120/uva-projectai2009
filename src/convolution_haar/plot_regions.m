...
%		side       -- front/rear
function plot_regions(Xsegs,Ysegs,bestModels,side)
	segsPerSide = Xsegs * Ysegs;
	if (strcmp(side,'rear')==1)
		imageName = 'moneyDivided/wholeplusborder/neur10/fit/f1.bmp';
	else
		imageName = 'moneyDivided/wholeplusborder/neur10/fit/r1.bmp';
	end
