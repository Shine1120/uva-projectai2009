...
\begin{document}
	...
	\section{Methods}\label{sec:Methods}
		...
		\subsection{Haar-like features and Convolution over kernels}\label{sec:Haar}
			...
			\begin{figure}[!hbtp]
				\fbox{\epsfig{file=img/patterns.jpg, width=0.9\linewidth} }	
				\caption{Patterns}
				\label{patterns}
			\end{figure}
			...
			\begin{figure}[!hbtp]
				\centering
				\epsfig{file=img/haar.jpg, width=1\linewidth}
			...
			\begin{figure}[!hbtp]
				\centering
				\epsfig{file=img/convolution.jpg, width=1\linewidth}
		...
		\subsection{Intensity and Edge distributions}\label{sec:Intensity_Edge}
            ...
            \begin{figure}[!hbtp]
				\centering 
				\epsfig{file=img/canny5euro.jpg, width=1\linewidth}
	...
	\section{Results}\label{sec:results}
		...
		\begin{figure}[!hbtp]
			\centering
			\epsfig{file=img/haar_regions10.jpg, width=1\linewidth}
		...
		\begin{figure}[!hbtp]
			\centering
			\epsfig{file=img/haar_regions5.jpg, width=1\linewidth}
		...
		\begin{figure}[!hbtp]
			\centering
			\epsfig{file=img/haar_plot10.jpg, width=1\linewidth}
			\caption{Error depending on the number of features - 10 Euro bills}
			\label{haar_plot10}
		\end{figure} 
		\begin{figure}[!hbtp]
			\centering
			\epsfig{file=img/haar_plot5.jpg, width=1\linewidth}
