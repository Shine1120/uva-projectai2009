...
for q=1:repetitions
	...
	for i=1:trials
		...
		money_front_regions1 = genImageRegions(money_front,1);
		...
		eigen_front_regions = genEigenFaceRegions(money_front_regions2);	
